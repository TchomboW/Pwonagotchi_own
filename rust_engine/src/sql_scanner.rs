...
#[derive(Debug, Clone)]
pub struct SQLScanner { pub username: String, pub password: String }
impl SQLScanner { pub fn new(u: &str, p: &str) -> Self { Self { username: u.to_string(), password: p.to_string() } } }
