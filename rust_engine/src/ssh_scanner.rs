...
#[derive(Debug, Clone)]
pub struct SSHScanner { pub username: String, pub password: String }
impl SSHScanner { pub fn new(u: &str, p: &str) -> Self { Self { username: u.to_string(), password: p.to_string() } } }
